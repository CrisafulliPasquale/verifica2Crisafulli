...
$sql = "SELECT assicurato.nome_assicurato, SUM(premi.premio_annuale) AS totale_premi
        FROM premi
        ...
        GROUP BY assicurato.codice_assicurato
...
if ($result->num_rows > 0) {
  while($row = $result->fetch_assoc()) {
    echo "Assicurato: " . $row["nome_assicurato"]. " - Totale Premi: " . $row["totale_premi"]. "<br>";
  }
} else {
